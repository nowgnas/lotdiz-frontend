  ...
  <div id='project-details-section'>
    ...
    <div id='details-project-info' v-if='projectDetails'>
      ...
      <div class='details-project-funding-info-amount-buyers'>
        <div id='details-accumulated-funding-amount'>
          <div class='details-accumulated-funding-amount '>
            {{ projectDetails.accumulatedFundingAmount }}
          </div>
          <div class='details-accumulated-funding-amount-suffix'> 원 달성</div>
        </div>
      ...
      <div class='likes-clap-funding'>
        <div class='details-likes-clap'>
          <div class='details-likes' @click='likes'>
            <div class='details-likes-logo'>
              <svg xmlns='http://www.w3.org/2000/svg' width='35' height='26' viewBox='0 0 35 28' fill='none'>
                <path
          ...
          <div class='details-support-signature' @click='modalControl'>

            <div class='details-support-signature-contents'>
              <div class='details-support-signature-logo'>
                <img alt='support-signature' class='details-support-signature-logo-img'
                     src='/common/clapping-icon.png' />
              </div>
              <div class='details-support-signature-count'>
                {{ projectDetails.numberOfSupporter }}
              </div>
            </div>
            <div class='details-support-signature-action'>
              지지서명하기
            </div>
          </div>
        </div>
      ...
      <div class='support-signature-modal-container'>
        ...
        <div class='support-signature-modal-write-button-box'>
          <div class='support-signature-modal-write-button'>
            ...
            <div class='support-signature-modal-write-button-contents' @click='createSupportSignatureRequest'>지지서명 하기
            </div>
          </div>
        </div>
