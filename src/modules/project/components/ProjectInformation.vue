...
<template>
  ...
  <div class="project-title-box">
    ...
    <input class="project-title-input" placeholder="제목을 입력해 주세요" @input="projectName" maxlength="40"/>
  ...
  <div class="thumbnail-image">
    ...
    <div class="camera-image-box" @click="addImage">
      <input ref="inputFile" @input="imageInput" @click="saveImage" type="file" style="display: none"/>
    ...
    <div class="search-tag-box">
      ...
      <input class="project-title-input" placeholder="태그를 입력해 주세요" @input="getProjectTag" maxlength="40"/>
    </div>
    <div class="project-register-save-box">
      <div class="save-btn">
        <div class="text">저장하기</div>
      </div>
    </div>
  </div>
