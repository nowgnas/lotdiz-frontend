    ...
    <div id="sign-in-wrapper">
      ...
      <div id="input-sign-in-wrapper">
        <div>
          ...
          <input type="text" id="input-sign-in-username" placeholder="email" />
        </div>
        <div>
          <div class="icon-wrapper">
...
#sign-in-container {
  ...
  background: linear-gradient(0deg, rgba(34,193,195,1) 0%, rgba(58,192,179,1) 34%, rgba(104,191,147,1) 62%, rgba(253,187,45,1) 100%);
  display: flex;
